...
This local-process plugin adapts the pinned `jiji262/douyin-downloader` provider to TrendRelay's media capability boundary. Use the repository-root `npm run douyin --` entry point; do not import upstream internals into core modules.
