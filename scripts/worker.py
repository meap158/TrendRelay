...
def process_available() -> int:
    job_ids = recoverable_job_ids("trend_research")
...
def worker_main() -> None:
    print("Durable worker ready: trend_research", flush=True)
    try:
        while True:
...
def main() -> int:
    ...
    parser.add_argument("--once", action="store_true", help="process currently available work")
    parser.add_argument("--watch", action="store_true", help="reload the worker after code changes")
