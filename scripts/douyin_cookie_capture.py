...
ANONYMOUS_MESSAGE = (
    "Douyin session saved. Single links and the hot board work, but a profile "
    "fetch stops after its first page (about 20 posts) and topic search is "
    "refused. Connect again and log in to lift both."
)
