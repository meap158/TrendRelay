...
export const fr: Messages = {
  ...
  autopilot: {
    ...
    needDestinations: "Au moins un compte de destination",
    needApproved: "Au moins un élément approuvé dans la file",
    ...
    queueHelp: "Les éléments tournent : un élément publié repart en fin de file au lieu d’être consommé. Seuls les éléments approuvés sont publiés.",
    noQueue: "La file est vide. Ajoutez un clip et le texte qui va avec.",
    approve: "Approuver",
    itemApproved: "Approuvé et entré dans la rotation.",
    itemRemoved: "Retiré de la file.",
