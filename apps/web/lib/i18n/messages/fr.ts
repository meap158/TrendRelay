...
export const fr: Messages = {
  ...
  discover: {
    ...
    countryForBoards: "Pays pour tous les tableaux Découvrir",
    tiktokCategories: { hashtags: "Hashtags", videos: "Vidéos" },
    ...
    news: {
      ...
      deskWorld: "Monde",
      deskWorldTitle: "Actualité générale",
      deskBusiness: "Économie",
      deskBusinessTitle: "Économie",
      deskTech: "Tech",
      deskTechTitle: "Technologie",
      densityLabel: "Niveau de détail",
      densityCards: "Cartes",
      densityCardsTitle: "Titre, résumé et sources",
      densityRows: "Lignes",
      densityRowsTitle: "Titre et sources",
      densityHeadlines: "Titres",
      densityHeadlinesTitle: "Titres seuls",
      refresh: "Actualiser",
      refreshing: "Lecture…",
      ...
      coveredBlurb: "Plusieurs rédactions le relaient en même temps.",
      breaking: "À l'instant",
      breakingBlurb:
        "Récent, et pour l'instant une seule rédaction le relaie.",
      readError: "Impossible de lire les rédactions.",
      partial:
        "{read} rédactions sur {requested} ont été lues. Les décomptes de couverture sont plus bas qu'ils ne le seraient autrement.",
      loading: "Lecture des rédactions…",
      empty:
        "Rien de nouveau dans ces rubriques ces dernières heures.",
      sinceJustNow: "à l'instant",
      sinceMinutes: "il y a {n} min",
      sinceHours: "il y a {n} h",
      sinceDays: "il y a {n} j",
      coveragePair: "{first} et {second}",
  ...
  library: {
    ...
    fromNotifications: "Résultats de la notification",
    itemsDone: "terminés",
    toRetry: "à réessayer",
    ...
    selectionActions: "Modifier la sélection",
    ...
    selectionActionVoiceoverHelp: "Générez la voix depuis la transcription validée de chaque clip.",
    actionNoCompatible: "Aucun média sélectionné ne prend en charge cette action.",
    actionLimit: "Choisissez jusqu'à {count, plural, one {# élément} other {# éléments}} pour cette action.",
    actionSkippedIncompatible: "{count, plural, one {# élément incompatible sera ignoré.} other {# éléments incompatibles seront ignorés.}}",
    actionCouldNotStart: "n'a pas pu être mis en file",
    actionBatchFailed: "{count, plural, one {# élément n'a pas pu être mis en file.} other {# éléments n'ont pas pu être mis en file.}}",
    selectionDialogDescription: "{count, plural, one {# élément sélectionné} other {# éléments sélectionnés}} · aperçu de {title}",
    createCaptionsFor: "Créer les sous-titres pour {count}",
    captionBatchQueued: "{count, plural, one {Sous-titres mis en file pour # élément.} other {Sous-titres mis en file pour # éléments.}}",
    generateVoiceoversFor: "Générer pour {count}",
    voiceBatchQueued: "{count, plural, one {Voix off mise en file pour # élément.} other {Voix off mises en file pour # éléments.}}",
    voiceBatchTranscriptNote: "Chaque élément utilise sa propre transcription validée. Les brouillons automatiques ne sont jamais lus.",
    voiceBatchMissingTranscript: "{count, plural, one {# élément sans transcription validée sera ignoré.} other {# éléments sans transcription validée seront ignorés.}}",
    voiceUnavailable: "La génération vocale est indisponible.",
    voiceChoose: "Voix",
    voiceChoosePlaceholder: "Choisir une voix",
    voiceNoVoices: "Aucune voix disponible",
    voiceDelivery: "Livraison",
    voiceDeliveryAudio: "Audio",
    voiceDeliveryVideo: "Sur le clip",
    voiceDeliveryBoth: "Les deux",
  ...
  publish: {
    ...
    renameThisAccount: "Renommer {label}",
    renameAccountHint: "Le nom de cette connexion. Celui du moteur figure à côté : celui-ci n'a qu'à dire laquelle.",
    accountRenamed: "Renommé en {label}.",
  ...
  autopilot: {
    ...
    needApproved: "Au moins une publication dont le texte est écrit",
  ...
  campaigns: {
    ...
    currentCount: "{count} en cours",
    visibility: "Visibilité des campagnes",
    scopeCurrent: "En cours ({count})",
    scopeArchived: "Archivées ({count})",
    scopeAll: "Toutes ({count})",
    noArchived: "Aucune campagne archivée.",
    noCurrent: "Aucune campagne en cours.",
    archivedAvailable: "Aucune campagne en cours. Les campagnes archivées sont accessibles ci-dessus.",
  ...
  attribution: {
   ...
   openShopeeProduct: "Ouvrir sur Shopee ↗",
    ...
    campaignsColumn: "Campagnes",
    notInCampaign: "Hors campagne",
    chooseCampaign: "Choisir une campagne…",
    chooseCampaignFirst: "Choisissez d’abord une campagne.",
    addToCampaign: "Ajouter à la campagne",
  ...
  fx: {
    ...
    cover_text: {
      label: "Masquer le texte à l'écran",
      summary: "Cacher les mots incrustés dans l'image, pour qu'une traduction puisse y tenir.",
      tag: "Masquer le texte",
      mode: "Comment le masquer",
      modeHelp: "L'aplat est exact et ressemble à un autocollant sur une image chargée. Le flou conserve la couleur et le mouvement du fond. La pixellisation est la plus visiblement délibérée des trois.",
      solidColour: "Aplat de couleur",
      blurred: "Flou",
      pixelated: "Pixellisation",
      colour: "Couleur",
      colourHelp: "Aplat uniquement. Accordez-la à l'image derrière les mots, pas aux mots.",
      black: "Noir",
      white: "Blanc",
      grey: "Gris",
      strength: "Intensité",
      strengthHelp: "Flou et pixellisation uniquement. Rapportée à la taille de chaque zone, pour qu'une ligne courte ne déborde pas.",
      regions: "Ce qu'il faut masquer",
      regionsHelp: "Repris de la lecture du texte à l'écran, en proportions de l'image. Lancez la lecture du clip dans la Médiathèque pour le remplir.",
    },
    colour: {
      label: "Couleur",
