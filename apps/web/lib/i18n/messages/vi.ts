...
export const vi: Messages = {
  ...
  attribution: {
    ...
    shopee: {
      ...
      exportDescription: "Ổn định cho tối đa 100 sản phẩm. Không cần đăng nhập TrendRelay, cookie hoặc CAPTCHA.",
      ...
      importAction: "Nhập {count} sản phẩm và tạo liên kết theo dõi",
      importOutcome: "Đã nhập {created} · đã tạo {links} liên kết theo dõi",
