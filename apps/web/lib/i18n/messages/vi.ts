...
export const vi: Messages = {
  ...
  attribution: {
    ...
    shopee: {
      ...
      excelRecommended: "Tệp Excel từ Shopee · đề xuất",
      excelDescription: "Ổn định cho tối đa 100 sản phẩm. Không cần đăng nhập TrendRelay, cookie hoặc CAPTCHA.",
      ...
      stepExport: "Chọn tối đa 100 sản phẩm và xuất tệp Excel.",
      ...
      excelLabel: "Tệp Excel do Shopee xuất",
      fileLimits: "Shopee .xlsx · tối đa 100 sản phẩm · tối đa 5 MB",
      ...
      chooseXlsx: "Chọn tệp .xlsx được xuất từ Hoa hồng Sản phẩm Shopee.",
      fileTooLarge: "Tệp lớn hơn 5 MB. Hãy xuất không quá 100 sản phẩm từ Shopee.",
      fileUnreadable: "Không thể đọc tệp Excel này.",
