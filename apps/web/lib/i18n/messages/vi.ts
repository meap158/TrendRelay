...
export const vi: Messages = {
  ...
  autopilot: {
    ...
    needApproved: "Ít nhất một bài đăng đã duyệt",
    ...
    queueHelp: "Bài đăng được dùng lại: bài đã đăng chuyển xuống cuối thay vì bị bỏ đi. Chỉ những bài đã duyệt mới được đăng.",
