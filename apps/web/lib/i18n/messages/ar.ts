...
export const ar: Messages = {
  ...
  autopilot: {
    ...
    needApproved: "منشور واحد على الأقل تمت الموافقة عليه",
    ...
    queueHelp: "تتكرّر المنشورات: المنشور الذي نُشر ينتقل إلى آخر القائمة بدل أن يُستهلك. ولا يُنشر إلا ما تمت الموافقة عليه.",
    noQueue: "القائمة فارغة. أضف مقطعًا والنص المرافق له.",
    approve: "اعتماد",
    itemApproved: "تمت الموافقة وأُدرج في الدورة.",
