...
export const en = {
  ...
  status: {
    queued: "Added as a draft. Approve it to start posting it.",
    running: "Running",
    succeeded: "Succeeded",
    failed: "Failed",
    partial: "Partly done",
  ...
  discover: {
    ...
    countryForBoards: "Country for every Discover board",
    tiktokCategories: { hashtags: "Hashtags", videos: "Videos" },
    ...
    news: {
      ...
      deskWorld: "World",
      deskWorldTitle: "General news",
      deskBusiness: "Business",
      deskBusinessTitle: "Business",
      deskTech: "Tech",
      deskTechTitle: "Technology",
      densityLabel: "How much to show",
      densityCards: "Cards",
      densityCardsTitle: "Headline, summary and sources",
      densityRows: "Rows",
      densityRowsTitle: "Headline and sources",
      densityHeadlines: "Headlines",
      densityHeadlinesTitle: "Headlines only",
      refresh: "Refresh",
      refreshing: "Reading…",
      ...
      coveredBlurb: "Several newsrooms are running this at once.",
      breaking: "Just in",
      breakingBlurb: "Recent, and so far only one newsroom has it.",
      readError: "The newsrooms could not be read.",
      partial:
        "Read {read} of {requested} newsrooms. Coverage counts are lower than they would otherwise be.",
      loading: "Reading the newsrooms…",
      empty: "Nothing has broken across these desks in the last few hours.",
      sinceJustNow: "just now",
      sinceMinutes: "{n}m ago",
      sinceHours: "{n}h ago",
      sinceDays: "{n}d ago",
      coveragePair: "{first} and {second}",
  ...
  library: {
    ...
    fromNotifications: "Notification results",
    itemsDone: "done",
    toRetry: "to retry",
    ...
    selectionActions: "Edit selected",
    ...
    selectionActionVoiceoverHelp: "Generate speech from each clip's reviewed transcript.",
    actionNoCompatible: "No selected media supports this action.",
    actionLimit: "Choose up to {count, plural, one {# item} other {# items}} for this action.",
    actionSkippedIncompatible: "{count, plural, one {# incompatible item will be skipped.} other {# incompatible items will be skipped.}}",
    actionCouldNotStart: "could not be queued",
    actionBatchFailed: "{count, plural, one {# item could not be queued.} other {# items could not be queued.}}",
    selectionDialogDescription: "{count, plural, one {# selected item} other {# selected items}} · previewing {title}",
    createCaptionsFor: "Create captions for {count}",
    captionBatchQueued: "{count, plural, one {Queued captions for # item.} other {Queued captions for # items.}}",
    generateVoiceoversFor: "Generate for {count}",
    voiceBatchQueued: "{count, plural, one {Queued voiceover for # item.} other {Queued voiceovers for # items.}}",
    voiceBatchTranscriptNote: "Each item uses its own reviewed transcript. Machine drafts are never voiced.",
    voiceBatchMissingTranscript: "{count, plural, one {# item has no reviewed transcript and will be skipped.} other {# items have no reviewed transcript and will be skipped.}}",
    voiceUnavailable: "Voice generation is unavailable.",
    voiceChoose: "Voice",
    voiceChoosePlaceholder: "Choose a voice",
    voiceNoVoices: "No voices are available",
    voiceDelivery: "Deliver",
    voiceDeliveryAudio: "Audio",
    voiceDeliveryVideo: "On the clip",
    voiceDeliveryBoth: "Both",
  ...
  publish: {
    ...
    renameThisAccount: "Rename {label}",
    renameAccountHint: "What to call this login. The engine's name is shown beside it, so this only has to say which one.",
    accountRenamed: "Renamed to {label}.",
    ...
    whichEngine: "Engine",
    removeThisAccount: "Remove {label}",
    ...
    noProductsToLink: "No products with affiliate links yet. Import them in Attribution.",
    chooseProductPrompt: "No product chosen",
    chooseProductAction: "Choose product",
    ...
    commentEngineLocked:
      "{platforms} takes a first comment, but {engine} cannot send one — only Buffer delivers first comments. Use a Buffer destination for it, or put the link in the caption.",
  ...
  autopilot: {
    ...
    lede: "Feeds the accounts below from the queue, at your posting times, and attaches the affiliate link where that link can be clicked.",
    ...
    needApproved: "At least one post with its copy written",
    ...
    destinations: "{count, plural, one {# account} other {# accounts}}",
  ...
  campaigns: {
    ...
    scopeCurrent: "Current ({count})",
    scopeArchived: "Archived ({count})",
    scopeAll: "All ({count})",
    noArchived: "No archived campaigns.",
    noCurrent: "No current campaigns.",
    archivedAvailable: "No current campaigns. Archived campaigns are available above.",
  ...
  attribution: {
    ...
    campaignsColumn: "Campaigns",
    notInCampaign: "Not in a campaign",
    chooseCampaign: "Choose a campaign…",
    chooseCampaignFirst: "Choose a campaign first.",
    addToCampaign: "Add to campaign",
    removeFromCampaign: "Remove from it",
    tagSelectionAria: "Campaign to tag the selection to",
    filterByCampaign: "Filter by campaign",
    allCampaigns: "All campaigns",
    filterByFile: "Filter by import file",
  ...
  composer: {
    ...
    choosePicturesForFrames: "Choose pictures to see them here.",
  ...
  fx: {
    ...
    fit: {
      ...
      ratio: "Shape",
      ratioHelp: "The whole picture stays; a blurred copy of it fills the rest.",
      vertical916: "9:16 vertical",
      portrait45: "4:5 portrait",
      square11: "1:1 square",
      landscape169: "16:9 landscape",
      blur: "Background blur",
      blurHelp: "As a share of the frame. Enough that the copy reads as backdrop rather than as a second picture.",
    },
    zoom: {
      label: "Zoom",
      summary: "Punch in on the picture, keeping its size and shape.",
      factor: "Zoom",
      factorHelp: "1.1 is a subtle reframe; past 1.3 the crop starts to show.",
      anchor: "Keep",
      anchorHelp: "Which part of the frame the zoom closes in on.",
      middle: "Middle",
      top: "Top",
      bottom: "Bottom",
    },
    region_blur: {
      ...
      x: "From the left",
      xHelp: "Where the region starts, as a share of the width.",
      y: "From the top",
      yHelp: "Where the region starts, as a share of the height.",
      width: "Width",
      widthHelp: "As a share of the frame. Clamped at the right edge.",
      height: "Height",
      heightHelp: "As a share of the frame. Clamped at the bottom edge.",
      blur: "Strength",
      blurHelp: "Against the region's own size, so a small region is not smeared past its edges.",
    },
    cover_text: {
      label: "Cover on-screen text",
      summary: "Hide the words burned into the picture, so a translation can sit there.",
      tag: "Cover text",
      mode: "How to cover it",
      modeHelp: "Solid is exact and shows as a sticker on a busy frame. Blur keeps the background's colour and motion. Pixelate is the most obviously deliberate of the three.",
      solidColour: "Solid colour",
      blurred: "Blur",
      pixelated: "Pixelate",
      colour: "Colour",
      colourHelp: "Solid only. Match the footage behind the words, not the words.",
      black: "Black",
      white: "White",
      grey: "Grey",
      strength: "Strength",
      strengthHelp: "Blur and pixelate only. Against each region's own size, so a short line is not smeared far past its edges.",
      regions: "What to cover",
      regionsHelp: "Taken from the clip's on-screen text reading, as shares of the frame. Read the clip in the Library to fill this in.",
    },
    colour: {
      label: "Colour",
