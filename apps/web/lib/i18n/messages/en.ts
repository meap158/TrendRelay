...
export const en = {
  ...
  autopilot: {
    ...
    needApproved: "At least one approved post",
    ...
    queueHelp: "Posts repeat: one that has gone out moves to the back rather than being used up. Only approved posts are ever sent.",
    noQueue: "Nothing queued yet. Add a clip and the copy to go with it.",
    approve: "Approve",
    itemApproved: "Approved, and now in the rotation.",
