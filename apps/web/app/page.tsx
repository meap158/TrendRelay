...
export default function Home() {
  return (
    <main>
      <nav><strong>TrendRelay</strong><Link href="/research">Trend Radar</Link><Link href="/workspaces">Workspaces</Link><Link href="/publish">Publish</Link><Link href="/tools">About &amp; Tools</Link></nav>
