...
directory. `MCP_GUIDE.md` is the control tower, loaded into the server's
initialization instructions and exposed at `trendrelay://mcp/guide`. Each action file declares a
